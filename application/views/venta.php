          ...
          <div class="modal-content">                    
            ...
            <div class="row">
              ...
              <div class="input-field col s12">
                <input type="text" placeholder="Buscar por nombre" v-model='nombreCliente' id='buscarCliente'>
                <label class="active" for="buscarCliente">Buscar</label>
              </div>
              <table class="bordered zui-table zui-table-horizontal zui-table-highlight centered">
                ...
                <tbody v-for='(p, i) in buscarCliente'>
                  <tr>
                    <td>{{p.idcliente}}</td>
                    <td>{{p.nombre}}</td>
                    <td>{{p.rut}}</td>    
                    <td><button class="btn-floating btn-small waves-effect waves-light white-text green" @click='agregarClienteGuia(p)' ><i class="material-icons">add</i></button></td>
                  </tr>
                </tbody>
              </table> 
              ...
              <div class="center">                                
                <button class="btn white-text black" @click="cerrarModalCliente()">CANCELAR</button>
              </div>   
              <!--
                                          <pre>{{$data}}</pre>-->
            </div>                       
            ...
            <div class="row">
              ...
              <div class="col s12 center">
                <div class="input-field">
                  <input @keyup="iniciarCantidad" class="center" id='modalCantidad' type="number" size="5" v-model='cantidad'>
                  <label class="active" for="modalCantidad">Cantidad</label>
                </div>         
        ...
        <div id="agregarProduct" class="modal">
          <div class="modal-content">                    
            ...
            <div class="row">
              ...
              <div class="input-field col s12">
                <input type="text" placeholder="Buscar por nombre, precio" v-model='name' id='buscarProducto'>
                <label class="active" for="buscarProducto">Buscar</label>
              </div>
              <table class="bordered zui-table zui-table-horizontal zui-table-highlight centered">
                <thead>
                  <tr>   
              ...
              <div v-show="opc == 1" class="row borde-padding">
                <div class="row no-margen">
                  ...
                  <div v-if="tipoVenta == 'guia'">
                    ...
                    <div class="input-field col s6 no-margen">
                      <input @keyup="iniciarBuscarCliente" type="number" id="guia" v-model="codigoGuia">
                ...
                <div class="row no-margen">
                  ...
                  <div v-if='tipoVenta == "guia"'>
                    ...
                    <div class="col s12">
                      <div class="row no-margen">                        
                        <div class="input-field col s12 margen-ariba">
                          <button class="btn margen-arriba2 blue accent-2 ancho-total" @click="cargarModalCliente()" >Buscar Cliente</button>
                        </div>
                      </div>
                    </div>
                    <div class="row no-margen">
                      <div class="col s6 no-marge-top">
                        <label for="nomP">Nombre cliente</label>
                        <div class="input-field no-marge-top">                                                
                          <input disabled="" type="text" id="nomP" v-model="clienteCargar.nombre" >
                        </div>    
                      </div>
                      <div class="col s6 no-marge-top">
                        <label for="rutP">Rut cliente</label>
                        <div class="input-field no-marge-top">
                          <input disabled="" type="text" id="rutP" v-model="clienteCargar.rut" >
                        </div>
                      </div>
                    </div>
                    <div class="col s12 no-marge-top">
                      <label for="giro">Giro Cliente</label>
                      <div class="input-field no-marge-top">
                  ...
                  <div class="col s4 margen-medio-arriba center">                                        
                    <input @keyup="iniciarEnter" type="text" id="productoBus" v-model='buscarProducto'>
                ...
                <table class="zui-table-highlight zui-table zui-table-horizontal borde-tabla">
                  ...
                  <tbody>
                    <tr v-for='p in estadoVentasBoleta'>
                      ...
                      <td class="center"><button class="btn-floating btn-small waves-effect waves-light white-text blue darken-3" @click='cargarModalDetalle(p)'><i class="material-icons">event_note</i></button></td>
                      <td class="center"><button class="btn-floating btn-small waves-effect waves-light white-text red lighten-1" @click='cargarModalPDF(p)'><i class="material-icons">picture_as_pdf</i></button></td>
                    </tr>
                  </tbody>
                </table>
              </div>  <!-- FIN CAJA -->
