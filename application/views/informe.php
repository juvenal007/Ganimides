  ...
  <body>
    ...
    <div id='newapp'>
      ...
      <main v-if="sesion[0].tipo == 'admin'">
        ...
        <div id="nguiaSii" class="modal">
          <div class="modal-content">
            <h5 class="center">Agregar N° Guia Sii</h5>
            <div class="divider"></div> 
            <div class="row no-margen">
              <div class="input-field col s6">
                <input type="text" id="nGuiaSii" v-model="nGuiaSii">
                <label for="nGuiaSii">N° Guía Sii</label>
              </div>
              <div class="input-field col s6">
                <button class="btn blue ancho-total" @click="agregarGuiaSii()">Agregar N° Guia Sii</button>
              </div>
            </div>  

            <br>
            <div class="center">
              <button class="btn black" @click="cerrarNguiaSii()">cerrar</button>
            </div>
            ...
            <div class="card-panel">      
                    ...
                    <table class="zui-table-highlight zui-table zui-table-horizontal borde-tabla">
                      ...
                      <tbody>
                        <tr v-for='p in ventas'>
                          ...
                          <td v-show="p.estado == 'FINALIZADA'">{{p.ventaTipo}}</td>
                          <td v-show="p.estado == 'FINALIZADA'">{{p.nguia_sii}}</td>
              ...
              <div v-show="opc == 3">       
                ...
                <div class="row no-margen">
                  ...
                  <div class="col s6">
                    ...
                    <div class="input-field">
                      <input type="number" id="nguia" v-model="idguia" />     
                    </div>
                  </div>
                ...
                <div class="row no-margen">
                  ...
                  <div class="input-field">
                    <input type="text" id="rutcliente" v-model="idcliente">
                ...
                <table class="zui-table-highlight zui-table zui-table-horizontal borde-tabla">
                  ...
                  <tbody>
                    <tr v-for='p in guias'>
                      ...
                      <td class="center"><button class="btn-floating btn-small waves-effect waves-light black-text yellow darken-3 " @click='modificarNguiaSii(p)'><i class="material-icons">create</i></button></td>
